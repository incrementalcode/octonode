...
(function()
{
  ...
  Repo = (function()
  {
    ...
    Repo.prototype.commits = function(cb, sha)
    {
      ...
      return this.client.get("/repos/" + this.name + "/commits", branch, function(err, s, b, h)
      {
        if (err)
        {
          return cb(err);
    ...
    Repo.prototype.issues = function()
    {
      ...
      return (_ref = this.client).get.apply(_ref, ["/repos/" + this.name + "/issues"].concat(__slice.call(params), [
        function(err, s, b, h)
        {
          if (err)
          {
    ...
    {
      var _this = this;
      return this.client.del("/repos/" + this.name,
      {}, function(err, s, b, h)
      {
        if ((err != null) || s !== 204)
        {
    ...
    Repo.prototype.prs = function()
    {
      var cb, params, _i, _ref;
      params = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), cb = arguments[_i++];
      return (_ref = this.client).get.apply(_ref, ["/repos/" + this.name + "/pulls"].concat(__slice.call(params), [
        function(err, s, b, h)
        {
          if (err)
          {
    ...
    Repo.prototype.stargazers = function()
    {
      var cb, params, _i, _ref;
      params = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), cb = arguments[_i++];
      return (_ref = this.client).get.apply(_ref, ["/repos/" + this.name + "/stargazers"].concat(__slice.call(params), [
        function(err, s, b, h)
        {
          if (err)
          {
